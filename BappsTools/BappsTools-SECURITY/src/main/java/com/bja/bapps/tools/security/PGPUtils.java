...
public class PGPUtils {
	...
	/** pour l'instant marche le mieux
	 ...
	 * @exception NoSuchProviderException
	 */
	public static byte[] encrypt(byte[] clearData, PGPPublicKey pgpPublicKey, char[] passPhrase,
			String fileName, int algorithm, boolean armor)
	throws IOException, PGPException, NoSuchProviderException {
		if (fileName == null) {
	...
	public static PGPPublicKey readPublicKey(InputStream in) throws IOException, PGPException {
		...
		throw new IllegalArgumentException("Erreur de lecture sur cle publique GPG");
	}
